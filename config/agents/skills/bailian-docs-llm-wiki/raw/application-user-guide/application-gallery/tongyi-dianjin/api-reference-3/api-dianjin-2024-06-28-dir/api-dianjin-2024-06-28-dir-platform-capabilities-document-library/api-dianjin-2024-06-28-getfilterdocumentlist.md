...
[您可以在OpenAPI Explorer中直接运行该接口，免去您计算签名的困扰。运行成功后，OpenAPI Explorer可以自动生成SDK代码示例。](https://api.aliyun.com/api/DianJin/2024-06-28/GetFilterDocumentList)

[![](https://img.alicdn.com/tfs/TB16JcyXHr1gK0jSZR0XXbP8XXa-24-26.png)调试](https://api.aliyun.com/api/DianJin/2024-06-28/GetFilterDocumentList)
...
### [](#文档库元信息-key-存储的-value-和输入的-value-之间的关系)文档库元信息 key 存储的 value 和输入的 value 之间的关系
